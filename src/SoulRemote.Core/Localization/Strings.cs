...
public static class Strings
{
    ...
    private static readonly Dictionary<string, (string En, string Fa)> Table = new(StringComparer.Ordinal)
    {
        ...
        ["bot.confirm.emoji.clear.toast"] = ("Confirm undo", "تأیید برگرداندن"),
        ["bot.confirm.emoji.clear.question"] = ("Put every emoji back to normal?", "همهٔ ایموجی‌ها به حالت عادی برگردند؟"),
        ...
        // ================= Telegram bot: premium emoji =================
        // The bot's own emoji, and which Telegram custom emoji stands in for each.
        ["bot.set.emoji"] = ("✨ Premium emoji", "✨ ایموجی پرمیوم"),
        ["bot.set.emoji.title"] = ("✨ <b>Premium emoji</b>", "✨ <b>ایموجی پرمیوم</b>"),
        ["bot.set.emoji.count"] = ("{0} of {1} emoji converted.", "{0} ایموجی از {1} تبدیل شده."),
        ["bot.set.emoji.pack"] = ("From the pack <b>{0}</b>.", "برگرفته از بستهٔ <b>{0}</b>."),
        ["bot.set.emoji.working"] = ("Telegram is showing them.", "تلگرام آن‌ها را نشان می‌دهد."),
        ["bot.set.emoji.refused"] = ("Telegram is dropping them. A bot may only send premium emoji if its owner has Telegram Premium, or if it has an extra username bought on Fragment.",
                                     "تلگرام آن‌ها را حذف می‌کند. بات تنها وقتی می‌تواند ایموجی پرمیوم بفرستد که مالکش اشتراک تلگرام پرمیوم داشته باشد، یا خودش نام کاربری اضافه‌ای از فرگمنت خریده باشد."),
        ["bot.set.emoji.untested"] = ("Not tried yet — the next panel will tell.", "هنوز آزموده نشده — پنل بعدی معلومش می‌کند."),
        ["bot.set.emoji.use"] = ("Use premium emoji", "به کار بردن ایموجی پرمیوم"),
        ["bot.set.emoji.import"] = ("✨ Convert everything from a pack", "✨ تبدیل همه با یک بسته"),
        ["bot.set.emoji.add"] = ("➕ Convert one emoji", "➕ تبدیل یک ایموجی"),
        ["bot.set.emoji.list"] = ("📋 Every emoji", "📋 فهرست ایموجی‌ها"),
        ["bot.set.emoji.clear"] = ("🗑 Undo them all", "🗑 برگرداندن همه"),
        ["bot.set.emoji.list.title"] = ("📋 <b>Every emoji the bot uses</b>", "📋 <b>ایموجی‌هایی که بات به کار می‌برد</b>"),
        ["bot.set.emoji.list.page"] = ("Page {0} of {1}.", "صفحهٔ {0} از {1}."),
        ["bot.set.emoji.list.hint"] = ("Tap a converted one to undo it, a plain one to convert it.",
                                       "روی تبدیل‌شده بزنید تا برگردد، روی ساده بزنید تا تبدیل شود."),
        ["bot.set.emoji.prev"] = ("◀ Previous", "◀ پیشین"),
        ["bot.set.emoji.next"] = ("▶ Next", "▶ پسین"),
        // Names for the handful of emoji the bot builds in code rather than storing as
        // a string, so the list has something to call them.
        ["bot.emoji.label.panel"] = ("Control panel", "پنل فرمان"),
        ["bot.emoji.label.warning"] = ("Warning", "هشدار"),
        ["bot.emoji.label.volume"] = ("Volume", "بلندی صدا"),
        ["bot.emoji.label.muted"] = ("Muted", "بی‌صدا"),
        ["bot.emoji.label.uptime"] = ("Uptime", "مدت روشن بودن"),
        ["bot.emoji.label.attachment"] = ("Attached file", "فایل پیوست"),
        ["bot.emoji.label.welcome"] = ("Welcome", "خوش‌آمد"),
        ["bot.emoji.label.waiting"] = ("Please wait", "کمی صبر کنید"),
        ["bot.emoji.label.online"] = ("Bot online", "بات آنلاین"),
        ["bot.emoji.label.blocked"] = ("Refused", "رد شد"),
        ["bot.emoji.label.relay"] = ("Relay test", "آزمایش رله"),
        ["bot.emoji.label.on"] = ("Switched on", "روشن"),
        ["bot.emoji.label.off"] = ("Switched off", "خاموش"),
        ...
        ["act.emoji.needpack"] = ("Send an emoji from the pack, or its link.", "یک ایموجی از بسته، یا پیوندش را بفرستید."),
        ["act.emoji.notemojipack"] = ("“{0}” is a sticker pack, not an emoji pack.", "«{0}» بستهٔ استیکر است، نه بستهٔ ایموجی."),
        ["act.emoji.nomatch"] = ("“{0}” has no version of any emoji this bot uses.", "«{0}» نسخه‌ای از هیچ‌یک از ایموجی‌های این بات ندارد."),
        ["act.emoji.imported"] = ("Converted {0} of {1} emoji from “{2}”.", "{0} ایموجی از {1} با «{2}» تبدیل شد."),
        ["act.emoji.needpremium"] = ("There was no premium emoji in that message.", "در آن پیام ایموجی پرمیومی نبود."),
        ["act.emoji.unused"] = ("That one stands for {0}, which this bot never shows.", "آن یکی به‌جای {0} است و بات هرگز نشانش نمی‌دهد."),
        ["act.emoji.wrongone"] = ("That one stands for {1}, not {0} — and Telegram only shows a premium emoji in place of the one it is a version of.",
                                  "آن یکی به‌جای {1} است، نه {0} — و تلگرام ایموجی پرمیوم را فقط جای همان ایموجی نشان می‌دهد."),
        ["act.emoji.added"] = ("{0} emoji converted.", "{0} ایموجی تبدیل شد."),
        ["act.emoji.added.one"] = ("That emoji is converted.", "همان ایموجی تبدیل شد."),
        ["act.emoji.removed"] = ("{0} is back to normal.", "{0} به حالت عادی برگشت."),
        ["act.emoji.cleared"] = ("Every emoji is back to normal.", "همهٔ ایموجی‌ها به حالت عادی برگشتند."),
        ...
        ["bot.prompt.emojipack"] = ("Send me one emoji from the pack you want, or paste its t.me/addemoji link.",
                                    "یک ایموجی از بستهٔ دلخواهتان برایم بفرستید، یا پیوند \u200Et.me/addemoji\u200E آن را جای‌گذاری کنید."),
        ["bot.prompt.premiumemoji"] = ("Send the premium emoji you want. Several at once is fine — each one converts the ordinary emoji it is a version of.",
                                       "ایموجی‌های پرمیوم دلخواهتان را بفرستید. چندتا با هم هم اشکالی ندارد — هرکدام همان ایموجی عادی خودش را تبدیل می‌کند."),
        ["bot.prompt.premiumemojifor"] = ("Send the premium version of that emoji.", "نسخهٔ پرمیوم همان ایموجی را بفرستید."),
        ["bot.placeholder.emojipack"] = ("t.me/addemoji/…", "t.me/addemoji/…"),
        ["bot.placeholder.premiumemoji"] = ("A premium emoji", "یک ایموجی پرمیوم"),
        ...
        ["ui.settings.emoji"] = ("PREMIUM EMOJI", "ایموجی پرمیوم"),
        ["ui.settings.emoji.hint"] = ("Dress the bot in a Telegram emoji pack. Each premium emoji stands in for the ordinary one it is a version of, so one pack converts everything it has a version of at once.",
                                      "بات را با یک بستهٔ ایموجی تلگرام بیارایید. هر ایموجی پرمیوم جای همان ایموجی عادی می‌نشیند که نسخه‌ای از آن است، پس یک بسته هرچه را نسخه‌اش را دارد یک‌جا تبدیل می‌کند."),
        ["ui.settings.emoji.use"] = ("Use premium emoji", "به کار بردن ایموجی پرمیوم"),
        ["ui.settings.emoji.use.hint"] = ("Off leaves the mapping alone and sends the plain emoji, so turning it back on costs nothing.",
                                          "خاموش کردنش نگاشت را دست‌نخورده می‌گذارد و ایموجی ساده می‌فرستد، پس روشن کردن دوباره‌اش هزینه‌ای ندارد."),
        ["ui.settings.emoji.pack"] = ("EMOJI PACK", "بستهٔ ایموجی"),
        ["ui.settings.emoji.pack.hint"] = ("A pack name or a t.me/addemoji link. You can also send one straight to the bot from Telegram, where the emoji keyboard is.",
                                           "نام بسته یا پیوند ‏t.me/addemoji‏. می‌توانید یکی را از خود تلگرام هم برای بات بفرستید، همان‌جا که صفحه‌کلید ایموجی هست."),
        ["ui.settings.emoji.import"] = ("Convert everything", "تبدیل همه"),
        ["ui.settings.emoji.clear"] = ("Undo them all", "برگرداندن همه"),
        ["ui.settings.emoji.count"] = ("{0} of {1} converted", "{0} از {1} تبدیل شده"),
        ["ui.settings.emoji.none"] = ("Nothing converted yet — the bot is using plain emoji.", "هنوز چیزی تبدیل نشده — بات ایموجی ساده به کار می‌برد."),
        ["ui.settings.emoji.working"] = ("Telegram is showing them.", "تلگرام آن‌ها را نشان می‌دهد."),
        ["ui.settings.emoji.refused"] = ("Telegram is dropping them. A bot may only send premium emoji if its owner has Telegram Premium, or if it has an extra username bought on Fragment.",
                                         "تلگرام آن‌ها را حذف می‌کند. بات تنها وقتی می‌تواند ایموجی پرمیوم بفرستد که مالکش اشتراک تلگرام پرمیوم داشته باشد، یا خودش نام کاربری اضافه‌ای از فرگمنت خریده باشد."),
        ["ui.settings.emoji.untested"] = ("Not tried yet — the bot's next message will tell.", "هنوز آزموده نشده — پیام بعدی بات معلومش می‌کند."),
        ["ui.settings.emoji.busy"] = ("Asking Telegram for that pack…", "درخواست آن بسته از تلگرام…"),
        ["ui.settings.emoji.offline"] = ("Connect the bot first — the pack has to be fetched through it.", "اول بات را وصل کنید — بسته باید از راه آن گرفته شود."),
        ["ui.settings.emoji.buttons"] = ("Buttons carry one premium emoji each, as an icon before the label; message text can carry them anywhere. The pop-up toasts and the \"/\" command list take plain emoji only — Telegram allows no formatting there.",
                                         "هر دکمه یک ایموجی پرمیوم به‌عنوان نشان پیش از برچسبش می‌گیرد؛ متن پیام هرجا می‌تواند داشته باشد. پیام‌های آنی و فهرست دستورهای «/» فقط ایموجی ساده می‌پذیرند — تلگرام آنجا هیچ قالب‌بندی‌ای نمی‌دهد."),
        ...
        ["cmd.emoji"] = ("Set the bot\'s premium emoji", "تنظیم ایموجی پرمیوم بات"),
